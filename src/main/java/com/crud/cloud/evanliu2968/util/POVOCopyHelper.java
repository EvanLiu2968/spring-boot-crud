...
//			Logger.debug("Using TypeConvertHelper to copy objects for java base type!");
    ...
    class BlockingDelegatePoVoCopy implements PoVoCopy {
        ...
        public <T> T copyTo(Object src, Object dest) {
            ...
            if (delegate == null) {
                log.warn("Create PoVoCopy fail, use DefaultPoVoCopy!");
    ...
    public PoVoCopy get(Object src, Object dest) {
        ...
        TypeConvertHelper.TypeConvert typeConvertSrc = TypeConvertHelper.me().getNullable(srcClass.getName());
        TypeConvertHelper.TypeConvert typeConvertDest = TypeConvertHelper.me().getNullable(destClass.getName());
        ...
        if (assignableMapSrc && typeConvertDest == null) {
            ...
            if (copy == null) {
                log.debug("Can't find PoVoCopy for {0} from map, try to create.");
                ...
                if (copy == null) {
                    log.error("Try to create PoVoCopy for {0} fail, use DefaultPoVoCopy instead.");
    ...
    protected synchronized PoVoCopy createCopyFromMap(String key, Class<?> srcClass, Class<?> destClass) {
        ...
        StringBuilder sb = new StringBuilder(512);
        {
            ...
            for (Entry<String, Method> entry : setterMap.entrySet()) {
                ...
                String fragment = ""/**/
                        ...
                        + "\n            }"/**/
                        + "\n        } catch(Exception e) {"/**/
                        + "\n            org.iff.infra.util.log.error( \" Copy map key value to property [{fieldName}] error! \", e );"/**/
                        + "\n        }"/**/;
        ...
        try {
            ...
            log.error("Create PoVoCopy class by source error, source: \n", e);
        }
        return null;
    }
        ...
        try {
            ...
            if (ParameterizedType.class.isInstance(types[0])) {
                ...
                if (args[0] instanceof Class) {
                    ...
                    log.warn("The method [{0}] parameter 0 WildcardType CANNOT be interface or abstract");
                }
            }
        } catch (Exception e) {
        }
        ...
        try {
            ...
            if (ParameterizedType.class.isInstance(type)) {
                ...
                if (args[0] instanceof Class) {
                    ...
                    log.warn("The method [{0}] return WildcardType CANNOT be interface or abstract");
                }
            }
        } catch (Exception e) {
        }
